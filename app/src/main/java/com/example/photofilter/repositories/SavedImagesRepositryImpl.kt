...
class SavedImagesRepositryImpl(private val context: Context): SavedImagesRepository {
    ...
    private fun getPreviewBitmap(file: File): Bitmap{
        ...
        val width = 150
        val heght = ((originalBitmap.height*width)/ originalBitmap.width)
        return Bitmap.createScaledBitmap(originalBitmap,width,heght,false)
    }
